...
class PembayaranController extends Controller
{
    ...
    public function proses(Request $request, $id)
    {
        ...
        if ($totalTerbayar <= 0) {
            ...
            $pesanMin = 'Minimal pembayaran DP adalah Rp ' .
                number_format($minBayar, 0, ',', '.');
            ...
            $pesanMin = 'Sisa tagihan yang harus dilunasi adalah Rp ' .
        ...
        $request->validate([
            ...
            'nominal_bayar.max'      => 'Nominal melebihi sisa tagihan Rp ' .
        ...
        try {
            ...
            $pembayaran->update([
                ...
                'jenis_pembayaran'  =>
                    ($request->nominal_bayar == $sisaTagihan)
                    ? 'pelunasan'
                    : 'dp',
