...
@section('page_title_content')
    <h1 style="margin: 0; font-size: 30px; font-weight: 700; color: #1a202c;">Dashboard</h1>
@endsection

@section('content')
<div style="font-family: 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; padding: 20px 30px; max-width: 1200px; margin: 0 auto; color: #333;">
